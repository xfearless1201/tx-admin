...
public class UserType {
    ...
    private Float jfImty;

    private Float pImgame;

    private Float jfImgame;
    ...
    public Float getJfEsw() {
        return jfEsw;
    }

    public void setJfEsw(Float jfEsw) {
        this.jfEsw = jfEsw;
    }
    ...
    public Float getJfCqj() {
        return jfCqj;
    }

    public void setJfCqj(Float jfCqj) {
        this.jfCqj = jfCqj;
    }
    ...
    public Float getJfImty() {
        return jfImty;
    }

    public void setJfImty(Float jfImty) {
        this.jfImty = jfImty;
    }
    ...
    public Float getJfImgame() {
        return jfImgame;
    }

    public void setJfImgame(Float jfImgame) {
        this.jfImgame = jfImgame;
    }
    ...
    public Float getJfNw() {
        return jfNw;
    }

    public void setJfNw(Float jfNw) {
        this.jfNw = jfNw;
    }
}