...
function yesterdayData(){ // 获取昨天的时间
 ...
 function sertFirstDay(){ // 获取本周的时间
    	...
    	var day;
   		...
   		$("#startTime1").val(WeekFirstDay.getFullYear()+"-"+month+"-"+day);
...
function showWeekLastDay(){   
   ...
   $("#endTime1").val(WeekLastDay.getFullYear()+"-"+month+"-"+day);
   searchFun();
}

function showMonthFirstDay(){ 
	
	var time_4 = new Date().format("yyyy-MM-01");
	var time_5 = new Date().format("yyyy-MM-dd");
	$("#startTime1").val(time_4); 
	$("#endTime1").val(time_5);
	searchFun();
}

function toDay(){ 
	var time_4 = new Date().format("yyyy-MM-dd");
	var time_5 = new Date().format("yyyy-MM-dd");
	$("#startTime1").val(time_4); 
	$("#endTime1").val(time_5);
	searchFun();
...
function lastWeekFirstDay(){
    ...
    $("#startTime1").val(formatDate(weekStartDate));
    $("#endTime1").val(formatDate(weekEndDate));
    searchFun();
}
