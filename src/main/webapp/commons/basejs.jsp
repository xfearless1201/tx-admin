...
<%-- [时间格式化JS] --%>
<script type="text/javascript" src="${staticPath }/static/dateFormat.js" charset="utf-8"></script>
<%--工具类--%>
<script type="text/javascript" src="${staticPath }/static/utilJs.js" charset="utf-8"></script> 